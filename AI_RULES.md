...
- Always give me BOTH links, clearly labelled:
    ...
    - "On your phone (same Wi-Fi):"  the network link (for example http://192.168.1.42:3000)
...
- Any time you mention a folder or file location, write the COMPLETE path from the drive letter onward, exactly as it is, so I can copy and paste it. For example: C:\Users\macie\Projects\mainsite
- Never abbreviate or shorten it. Never write "the folder", "this folder", or "...\mainsite". I need the whole thing, copy-paste ready, every time.
...
- Every time you finish a task, end your message with TWO confirmations:
    1. The FULL folder path you applied the change to (complete, copy-paste ready), so I can see it landed in the right place. For example: C:\Users\macie\Projects\mainsite
